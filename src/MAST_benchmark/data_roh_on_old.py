...
# from MAST_benchmark.tools.path import METADATA_DIR  # FIXME: Remove and use new architecture?


# ----------------------------------------------------------------------------------------------------------------------
def initialize_MAST_dataset(  # noqa N802
    ...
    -------
    MastDataset
        Initialized MastDataset instance.
